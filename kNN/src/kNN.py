...
def classify0(inX, dataSet, labels, k):
    ...
    sortedDistanceIndices = distances.argsort() # argsort index of sorted array
    classCount={}
    for index in range(k):
        voteIlabel = labels[sortedDistanceIndices[index]]
...
def plotDataSet(dataSet,dataLabels):
    fig = plt.figure()
    ax = fig.add_subplot(111)
    ax.scatter(dataSet[:,0],dataSet[:,1],15.0*array(dataLabels),15.0*array(dataLabels))
